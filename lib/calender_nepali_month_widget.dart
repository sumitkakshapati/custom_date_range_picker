...
class CalenderNepaliMonthWidget extends StatelessWidget {
  final NepaliDateTime? startDate;
  final NepaliDateTime? endDate;
  final List<NepaliDateTime> currentMonthDays;
  final NepaliDateTime currentMonthDate;
  final NepaliDateTime? minimumDate;
  final NepaliDateTime? maximumDate;
  final ValueChanged<NepaliDateTime> onDateClick;
  const CalenderNepaliMonthWidget({
    super.key,
    this.startDate,
    this.endDate,
  ...
  List<Widget> _getDaysNoUI(BuildContext context) {
    ...
    for (int i = 0; i < currentMonthDays.length / 7; i++) {
      ...
      for (int i = 0; i < 7; i++) {
        final NepaliDateTime date = currentMonthDays[count];
